...
//        Org org = enterprise.getOrganizationsDirectory().addOrganizations(Org.Type.Transportation);
...
//        person.setName();
//
//        account = org.getUserDirectory().addUser("driver", "driver", person, new DriversRole());
//        account.setNetwork(Network);
//        account.setEnabled(true);
        ...
        Org org = enterprise.getOrganizationsDirectory().addOrganizations(Org.Type.Manager);
        person = org.getPersonDirectory().addPerson();
